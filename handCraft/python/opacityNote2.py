...
#--------------------:
#save note to file.txt and re-read from file.txt
#copy/past Other LABELS content.
#resize by ctrl +/- TEXT EDITOR
#ADJUST OPACITY BY ALT +/-
#SET WITDGET TO (0,0) by ctrl+5

#use Memo to show adress and value from memo.txt (sharedMemo)
#add button to control Memo refresh (lower rate)
#hide show all buttons

#make memo ctrl+(edit raw text) for copy.
#:::::::::::::::::::::::::::::::::::::::::::::::::::
